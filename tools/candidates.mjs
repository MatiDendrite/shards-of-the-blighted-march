...
try{
 ...
 for(const id of ['mage','ninja','dwarf'])groups[id]=[`game/assets/${id}.js`,`work/candidates/${id}_blocks.js`,`work/candidates/${id}_panels.js`];
 ...
 Object.assign(groups,{house_relief_detail:['game/assets/village_house.js','work/candidates/house_before_relief.js','work/candidates/house_hip.js'],gate_relief_detail:['game/assets/old_gate.js','work/candidates/gate_before_relief.js','work/candidates/gate_profile.js'],stone_relief_detail:['game/assets/standing_stone.js','work/candidates/stone_before_relief.js']});
 Object.assign(groups,{house_surface_detail:['game/assets/village_house.js','work/candidates/house_before_surface.js','work/candidates/house_hip.js'],stall_surface_detail:['game/assets/market_stall.js','work/candidates/stall_before_surface.js','work/candidates/stall_lean.js']});
 ...
 await page.setViewport({width:files.length*480,height:900});
 ...
 const report=await page.evaluate(async ({sources,group})=>{
  ...
  const renderer=new T.WebGLRenderer({antialias:true,preserveDrawingBuffer:true});renderer.setSize(sources.length*480,900);renderer.setPixelRatio(1);renderer.setClearColor(0x303936);renderer.setScissorTest(true);renderer.toneMapping=T.ACESFilmicToneMapping;document.body.append(renderer.domElement);
