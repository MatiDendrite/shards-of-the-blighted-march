...
// The surface-detail pass deliberately budgets 9k for clipped shingles and
// gable framing; scene-level render/404 budgets remain unchanged.
for(const [name,generate,budget,width] of [['house',house,9000,6.4],['stall',stall,3000,3.5],['well',well,3000,2.6]])test(`${name}: detailed constructor stays grounded and inside its art budget`,()=>{
