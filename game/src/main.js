...
async function boot(){
  ...
  function frame(now){
    ...
    if(started&&world.interior!==interiorShown){interiorShown=world.interior;if(interiorShown)combatView.notice(`${interiorShown.name} · warm, safe and out of the wind`,2.5);}
