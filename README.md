...
Approach Alden, Mara or Rowan and press **E** (or the touch prompt) to talk. Mara sells healing draughts in every settlement; Borin's forge remains in Hearthstead. **M**, or tapping the HUD minimap, opens the detailed regional atlas: actual building footprints, roads, trees, rocks, NPC services, enemies, loot and your heading. Drag to pan, use the wheel or +/− to zoom, and select Town, Find me or a location. **M / Escape** closes it; gameplay pauses while it is open. **J** keeps the quest journal and regional travel. Houses are exterior landmarks, not enterable interiors.
