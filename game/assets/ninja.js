// Original 404 character study: ninja, profiles construction.
export default function generate(T){
 ...
 shell(head,cloth,[[.174,-.17],[.17,.04],[.13,.14],[0,.205]],.86,0,0,-.015,.50,Math.PI*2-1);
 for(const side of ['left','right']){const {leg,shin,arm,fore}=limbs[side];
  ...
  shell(arm,cloth,[[.135,-.12],[.145,.015],[.09,.09]],.96);ball(arm,cloth,0,.054,0,.096,.055,.096);
 }
