...
export const CLASSES = {
 ...
 mage:{name:'Mage',role:'Fire & frost',description:'Launch fire from afar, slow pursuers with frost, then blink to safety.',skills:['firebolt','frostnova','blink'],color:'#acb7ef'},
...
export const SKILLS={
 ...
 venom:{name:'Venom Knives',description:'Throw three knives up to 9 m. Each hit poisons for 24 extra damage over 4 seconds. Poison refreshes; it does not stack.',cost:24,cooldown:7,windup:.2,active:.1,recovery:.25,damage:14,range:9,arc:.5,effect:'projectile',speed:16,poison:true,color:0x8bdb8c},
 ...
 cinderbomb:{name:'Cinder Bomb',description:'Throw a charge up to 5.5 m. After 1.1 seconds it explodes in a 2.6 m circle. Obstacles stop the throw.',cost:28,cooldown:8,windup:.3,active:.1,recovery:.28,damage:52,range:5.5,arc:0,effect:'bomb',color:0xffbc65},
