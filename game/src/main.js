...
async function boot(){
  ...
  $('#startb').onclick=()=>{audio.unlock();started=true;world.decorate().catch(error=>console.error('Scenery dressing failed',error));$('#welcome').hidden=true;$('#hud').hidden=false;input.clear();save();document.activeElement?.blur();};
