...
export function createAudio(){
 ...
 function play(type){if(!ctx||muted||ctx.state!=='running')return;
  const sounds={swing:[170,.10,'triangle'],hit:[85,.11,'square'],hurt:[62,.20,'sawtooth'],dodge:[340,.08,'sine'],cry:[180,.35,'triangle'],explosion:[45,.65,'sawtooth'],equip:[440,.10,'sine'],death:[55,.7,'triangle']};
